...
const LoginPage = () => {
  ...
  return (
    <div className={ `${styles.container} flex justify-center items-center h-full`}>
      ...
      <div className=' flex-grow flex p-2  h-[450px] mt-12 max-w-[300px] justify-around mb-12 pb-10 pl-[50px] bg-neutral-400 items-center shadow-lg shadow-green-800  rounded-xl'
        >
