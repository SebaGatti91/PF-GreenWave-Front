            ...
            <div >
              ...
              <div className="flex flex-col justify-center items-center">
                <div className="flex justify-center flex-row items-center">
                  ...
                  <button className="px-3 py-1" onClick={() => { countDownCart(id) }} style={{ display: item.count > 0 ? 'block' : 'none', border: '1px solid gray' }}>-</button>
                  <h3 className="bg-slate-500 px-3 py-1">{item.count}</h3>
                  <button className="px-3 py-1"  onClick={() => { countUpCart(id) }} style={{border: '1px solid gray'}}>+</button>
                </div>
